...
// p.then(data => console.log("aung",data));
// p.catch(data => console.log("kya dal",data));
...
async function go(){
    const product1 = await fetch('https://dummyjson.com/products/1'); //repsponse obj
    const response1 = await product1.json();
    console.log(response1);

    const product2 = await fetch('https://dummyjson.com/products/2'); //repsponse obj
    const response2 = await product2.json();
    console.log(response2);

    const product3 = await fetch('https://dummyjson.com/products/3'); //repsponse obj
    const response3 = await product3.json();
    console.log(response3);

    const product4 = await fetch('https://dummyjson.com/products/4'); //repsponse obj
    const response4 = await product4.json();
    console.log(response4);

    const product5 = await fetch('https://dummyjson.com/products/5'); //repsponse obj
