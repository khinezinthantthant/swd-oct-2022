...
//     }
//     about(){
//         return `${this.name} is ${this.age} year${this.age >1 && "s"} and ${this.pronoun} was born in ${this.birthYear}. now ${this.pronoun} attend ${this.major} major`
//     }
// }
...
// const st2 = new Student("Su Su","female",16,"eco");
// console.log(st2);
...
// const str ="min ga lar byar";//data type string
...
const num = new Number(234.5678);
const strNum = "234.5678";
const weight ="160.58kg";
// const weight ="kg160.58";
// console.log(typeof num);
// console.log(num);
// console.log(num.toString());
// console.log(num.toFixed(2));
// console.log(num.toPrecision(2));
// console.log(Number("123.23")); //Number constructor
...
// console.log(isNaN("hein"-"hein"));
// console.log(isNaN(15+3));
...
// console.log(Math.ceil(123.16));
// console.log(Math.floor(123.96));
...
// const run = (x,y) => x+y;
// const run = () => "this is arrow function";
...
// console.dir(run.arguments);

// console.log(run.bind(null,1,2,3,4,5).call());
console.log(run(1,2));
